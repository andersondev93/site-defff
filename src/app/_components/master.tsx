...
export function Master() {
    return (
        <section className="w-full h-[474px] lg:h-[374px]">

            <div>
                <h1 className='text-orange-600 mt-2 text-[32px] text-center font-bold md:text-4xl xl:text-5xl'>PATROCÍNIO MASTER</h1>
            </div>

            <div className='max-w-[1246px] px[15px] mx-auto flex items-center justify-center flex-col my-4 lg:h-[296px] lg:flex-row gap-8'>
                <Image
                    src={areal}
