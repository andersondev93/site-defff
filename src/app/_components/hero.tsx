        ...
        <section className="w-full h-[704px] md:h-[416px] xl:h-[704px] bg-img_bg_hero bg-no-repeat bg-center bg-cover overflow-hidden">
            ...
            <div className='flex-1 max-w-[350px] md:max-w-[497px]  md:ml-4'>
                ...
                <div className="flex text-white mb-8">
                    <a href="#" className="bg-green-500 px-5 py-2 rounded-md font-semibold flex items-center justify-center gap-2"
                ...
                <Image
                    src={abadaImg}
                    alt='Foto do abada'
                    className='w-[508px] h-[416px] xl:mr-[-41px] xl:w-[860px] xl:h-[704px] ml-0'
                    data-aos="fade-left"
                    data-aos-delay="200"
                />
            </Container>
