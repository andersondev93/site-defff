...
export function Abada() {
    return (
        <section className="w-full h-[865px] lg:h-[704px] xl:h-[704px] overflow-hidden flex">
            ...
            <div className="flex items-center justify-center lg:justify-around w-full max-w-[1246px] px[15px] mx-auto flex-col lg:flex-row">
                ...
                <Image
                        src={abada}
                        alt='Foto do abada 2'
                        className='w-[456px] h-[416px] shadow-2xl xl:w-[662px] xl:h-[604px] rounded-3xl mb-4 lg:mb-0'
                        data-aos="zoom-in"
                    />
