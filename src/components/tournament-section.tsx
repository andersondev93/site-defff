    ...
    <section className="py-12 bg-[#3f743f] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="bg-linear-to-br from-primary to-[#a8d900] rounded-2xl p-1 shadow-2xl">
            <div className="bg-[#1a2e1a] rounded-xl p-6 md:p-8">
              <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                {/* Icon */}
                <div className="shrink-0">
                  <div className="w-30 h-40 rounded-full flex items-center justify-center">
                    <img src="/images/torneio.png" alt="Logo do Torneio Society" className="w-30 h-40" />
